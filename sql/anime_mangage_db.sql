/*
 ...
 Source Schema         : anime_mangage_db
...
-- Create database
-- ----------------------------
DROP DATABASE IF EXISTS `anime_mangage_db`;
CREATE DATABASE `anime_mangage_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `anime_mangage_db`;
...
CREATE TABLE `t_video_info`  (
  ...
  `video_category` tinyint(1) NULL DEFAULT NULL COMMENT '动漫元数据',
  `create_time` date NULL DEFAULT NULL,
  `creator_id` int(11) NULL DEFAULT NULL COMMENT '动漫记录占位',
  `last_modify_time` datetime(0) NULL DEFAULT NULL,
  `video_url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '海报/封面地址',
