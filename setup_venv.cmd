@echo off
REM =====================================================================
REM  anime-system - Python virtual env one-click setup script
REM  Usage: after copying the whole anime-system folder to a new machine,
REM         double-click this file in anime-system root directory.
...
echo.
echo [OK] Done! Virtual env is ready at anime-system\.venv
