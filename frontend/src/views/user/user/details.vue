<template>
  <div class="app-container">
    ...
    <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading" >
      ...
      <el-form-item :key="index" :label="'动漫操作'+(index+1)+'：'" required v-for="(titleItem,index) in form.userOperationList">
        <el-input v-model="titleItem.videoName" style="width: 80%"/>
      </el-form-item>
      <el-form-item :key="index" :label="'动漫推荐'+(index+1)+'：'" required v-for="(titleItem,index) in form.userRecommendList">
